            ...
            <div class="mm-nova-inline-selector">
                <div class="mm-relative mm-mt-2">
                    <button
                        ...
                        type="button"
                        class="mm-relative mm-w-full mm-cursor-pointer mm-rounded-md mm-bg-white mm-py-1.5 mm-pl-3 mm-pr-10 mm-text-left mm-text-gray-900 mm-shadow-sm mm-ring-1 mm-ring-inset mm-ring-gray-300 mm-focus:outline-none mm-focus:ring-2 mm-focus:ring-indigo-500 mm-sm:text-sm mm-sm:leading-6"
                    ...
                    >
                        ...
                        >
                            <span
                                v-html="
                                    this.getOptionAvatar(selectedOption.value)
                                "
                            />
                            <span class="mm-ml-3 mm-block mm-truncate">
                    ...
                    <ul
                        :class="[
                            selectOptionsOpen ? 'mm-visable' : 'mm-hidden',
                        ]"
                        class="mm-absolute mm-z-10 mm-mt-1 mm-max-h-56 mm-w-full mm-overflow-auto mm-rounded-md mm-bg-white mm-py-1 mm-text-base mm-shadow-lg mm-ring-1 mm-ring-black mm-ring-opacity-5 mm-focus:outline-none mm-sm:text-sm"
                        tabindex="-1"
                        role="listbox"
                        aria-labelledby="listbox-label"
...
export default {
    ...
    methods: {
        ...
        getOptionAvatar(value) {
            return find(this.field.avatarImages, function (v, k) {
                return k == value;
            });
        },
